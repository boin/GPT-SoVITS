    ...
    with gr.Tabs():
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            with gr.TabItem(i18n("1A-训练集格式化工具")):
                ...
                with gr.Row():
                    with gr.Row():
                        inp_text = gr.Textbox(label=i18n("*文本标注文件"),value=r"TeamSpace/TTD-Space",interactive=True,scale=10)
                    with gr.Row():
                ...
                with gr.Row():
                    with gr.Column():
                        with gr.Row():
                            ...
                            total_epoch1Bb = gr.Slider(minimum=2,maximum=1000,step=1,label=i18n("总训练轮数total_epoch"),value=15,interactive=True)
                        with gr.Row():
